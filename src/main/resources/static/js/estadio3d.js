...
function crearEstadio() {
    // Campo de fútbol (césped con textura)
    ...
    crearZonaAsientos('Tribuna', { x: 0, y: 0, z: -65 }, 10, 25, 0);
    crearZonaAsientos('Grada Lateral', { x: -50, y: 0, z: 0 }, 12, 15, Math.PI / 2);
    crearZonaAsientos('Grada Lateral', { x: 50, y: 0, z: 0 }, 12, 15, -Math.PI / 2);
    crearZonaAsientos('Gol Nord', { x: 0, y: 0, z: 65 }, 8, 25, Math.PI);
}
...
async function cargarDatosEstadio() {
    try {
        ...
        // Crear promesa con timeout más corto
