...
class EstadioCanvas {
    ...
    dibujarEtiquetasZonas() {
        ...
        const etiquetas = [
            // Gol Nord sections
            { texto: 'Gol Nord', x: 0, y: -530, color: '#FFD700', fontSize: LARGE_FONT_SIZE },

            // Gol Sud sections
            { texto: 'Gol Sud', x: 0, y: 530, color: '#FFD700', fontSize: LARGE_FONT_SIZE },

            // Grada total (external labels on sides)
            { texto: 'Grada lateral y tribuna', x: -520, y: 0, rotacion: -Math.PI / 2, color: '#FFD700', fontSize: LARGE_FONT_SIZE },
            { texto: 'Grada lateral y tribuna', x: 520, y: 0, rotacion: Math.PI / 2, color: '#FFD700', fontSize: LARGE_FONT_SIZE },
